...
public class StuDao {
	...
	public static void changeStudent(Student stu,String id){
		...
		Element element=(Element) document.selectSingleNode("//student[@id="+id+"]");
		Element course=element.element("course");
		Element course_java= (Element) course.element("java");
		Element course_oracle=(Element) course.element("oracle");
		Element course_vb=(Element) course.element("vb");
